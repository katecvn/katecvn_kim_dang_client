...
import { createCreditNote } from '@/stores/CreditNoteSlice'
import { getCreditNoteDetail } from '@/api/credit_note'
...
const CreateCreditNoteDialog = ({
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (hasPrintInvoice) {
        const creditData = await getCreditNoteDetail(newInvoice.id)
