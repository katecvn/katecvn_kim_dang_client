...
const GeneralSettingPage = () => {
  ...
  useEffect(() => {
    if (setting?.payload) {
      form.reset({
        generalSetting: {
          brandName: setting.payload.brandName || '',
          logo: setting.payload.logo || '',
          name: setting.payload.name || '',
          email: setting.payload.email || '',
          phone: setting.payload.phone || '',
          address: setting.payload.address || '',
          taxCode: setting.payload.taxCode || '',
          website: setting.payload.website || '',
          banks:
                      ...
                      <ul className="list-inside list-disc">
                        <li className="flex items-center space-x-2">
                          ...
                          <span>
                            ...
                            <strong>{setting?.updater?.fullName}</strong>
                          </span>
                        </li>
