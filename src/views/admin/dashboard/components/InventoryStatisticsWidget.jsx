...
export default function InventoryStatisticsWidget() {
  ...
  }, [selectedSupplierId, selectedCategoryId])
  ...
  return (
    <div className="bg-white rounded-lg border mt-8">
      <div className="p-6">
        <div className="mb-4">
          <h3 className="text-xl font-bold tracking-tight">Thống kê sản phẩm</h3>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* Data Table */}
          {reportData.length > 0 && (
            <div className="overflow-x-auto overflow-y-auto max-h-[500px] rounded-lg border bg-white relative">
