...
import ExportInstallmentV2 from './ExportInstallmentV2'
import { cn } from '@/lib/utils'
import { statuses } from '../../sales-contract/data'

const safe = (v, fallback = '') => (v === 0 || v ? String(v) : fallback)

export default function InstallmentPreviewDialogV2({
  open,
  onOpenChange,
  initialData,
  onConfirm,
        ...
        <div className="space-y-2">
          ...
          <label className="block text-xs font-medium">
            ...
            <Textarea
              className="mt-1 text-xs"
              rows={2}
              value={safe(formData.transferNote)}
    ...
    <div className="flex-1 overflow-auto rounded border bg-muted/40 p-2">
      ...
      <div className={isMobile
        ...
        <div style={isMobile ? {
          ...
          <ExportInstallmentV2 data={formData} />
        </div>
      </div>
    </div>
  )
          ...
          <>
            <DialogHeader className="px-4 pt-4 pb-2 shrink-0 border-b">
              <DialogTitle className="text-base">
                Xem trước & chỉnh sửa hợp đồng (V2)
              </DialogTitle>
            </DialogHeader>
